...
// <tenant>.<apex>/admin. NEXT_PUBLIC_COOKIE_DOMAIN (e.g. ".benditarifa.com")
...
describe("getAuthCookieOptions", () => {
  ...
  it("returns the configured parent domain", () => {
    process.env.NEXT_PUBLIC_COOKIE_DOMAIN = ".benditarifa.com";
    expect(getAuthCookieOptions()).toEqual({ domain: ".benditarifa.com" });
  });
});
